 **一个用于的APM Gradle插件，对指定的路径下的方法进行插装，统计方法执行时间，内存信息，电量信息，标记执行时间超出5000毫秒的方法,为APM 提供数据参考.**
 ...
 **Python 部分** ：利用pyechats 生成图标，[Python 源文件路径](./python/APM_MT.py)

APM(意思是Android 性能优化)，MT（Method Trace）

# =================================================

# 快速使用（请在Debug 模式下使用,release下会有问题还有问题）

请以 buildSrc 方式使用,具体看源码
插件版本暂时没有更新，
